...
if dropout
    [W1, tr_acc1, te_acc1,tr_loss1,te_loss1] = t_perceptron_d(a1,train_d_1,train_l,test_d_1,test_l);
else
    [W1, tr_acc1, te_acc1,tr_loss1,te_loss1] = t_perceptron(train_d_1,train_l,test_d_1,test_l);
end
