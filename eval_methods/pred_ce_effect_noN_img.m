...
rbms_pass = 1./(1 + exp(-cong_l_d*vishid_2 - repmat(hidbiases_2,size(cong_l_d,1),1)));
% add biases
...
% pass data throught RBMs:
rbms_pass = 1./(1 + exp(-cong_pl_d*vishid_2 - repmat(hidbiases_2,size(cong_pl_d,1),1)));
% add biases
ONES = ones(size(rbms_pass, 1), 1);  
rbms_pass = [rbms_pass ONES];
% Compute prediction:
...
% pass data throught RBMs:
rbms_pass = 1./(1 + exp(-inc_l_d*vishid_2 - repmat(hidbiases_2,size(inc_l_d,1),1)));
% add biases
ONES = ones(size(rbms_pass, 1), 1);  
rbms_pass = [rbms_pass ONES];
% Compute prediction:
...
% pass data throught RBMs:
rbms_pass = 1./(1 + exp(-inc_pl_d*vishid_2 - repmat(hidbiases_2,size(inc_pl_d,1),1)));
% add biases
ONES = ones(size(rbms_pass, 1), 1);  
rbms_pass = [rbms_pass ONES];
% Compute prediction:
