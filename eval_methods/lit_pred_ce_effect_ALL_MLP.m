...
if ii==1
    matrix_1_mlp = table(Subjects,Letter,Contour,accs_i,accs);
    matrix_1_pd_mlp = table(Subjects,Letter,Contour,A,H,M,T,U,X,cross,elipse,hexa,rect,square,trian);
else
    ...
    matrix_1_pd_mlp = cat(1,matrix_1_pd_mlp,m_p);
end
...
if ii==1
    matrix_3_mlp = table(Subjects,Letter,Cong_Acc,Acc_inc_a,Acc_inc_b,a,b);
else
    m3i = table(Subjects,Letter,Cong_Acc,Acc_inc_a,Acc_inc_b,a,b);
    matrix_3_mlp = cat(1,matrix_3_mlp,m3i);
end
