...
rbms_pass_s = 1./(1 + exp(-s_data*vishid_2 - repmat(hidbiases_2,size(s_data,1),1)));
if numhid3 ~= 0
...
rbms_pass_l = 1./(1 + exp(-data*vishid_2 - repmat(hidbiases_2,size(data,1),1)));
if numhid3 ~= 0
...
% pass letterdata throught RBMs:
rbms_pass_pl = 1./(1 + exp(-data*vishid_2 - repmat(hidbiases_2,size(data,1),1)));
if numhid3 ~= 0
