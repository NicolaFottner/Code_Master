...
f = figure;
% for letter A:
subplot(6,2,1);bar(pdfs(1,:));xlabel('Triangle / H');
subplot(6,2,2);bar(pdfs(2,:));xlabel('Triangle / U');
% for letter H:
subplot(6,2,3);bar(pdfs(3,:));xlabel('Rectangle / A');
subplot(6,2,4);bar(pdfs(4,:));xlabel('Rectangle / U');
% for letter M:
subplot(6,2,5);bar(pdfs(5,:));xlabel('Square / T');
subplot(6,2,6);bar(pdfs(6,:));xlabel('Square / X');
% for letter U:
subplot(6,2,7);bar(pdfs(7,:));xlabel('Elipse / A');
subplot(6,2,8);bar(pdfs(8,:));xlabel('Elipse / H');
% for letter T:
subplot(6,2,9);bar(pdfs(9,:));xlabel('Cross / M');
subplot(6,2,10);bar(pdfs(10,:));xlabel('Cross / X');
% for letter X:
subplot(6,2,11);bar(pdfs(11,:));xlabel('Hexagon / M');
subplot(6,2,12);bar(pdfs(12,:));xlabel('Hexagon / T');
sgtitle("Incongr: Detailed - Predictions/Prob Distr on CE-data: ");
file_namee = "Evals/plots/" + str_date + "_incDETailed_L_prD"+".png";
exportgraphics(f,file_namee);
clear figure;
...
f = figure;
% for letter A:
subplot(6,2,1);bar(pdfs(1,:));xlabel('Triangle / pH');
subplot(6,2,2);bar(pdfs(2,:));xlabel('Triangle / pU');
% for letter H:
subplot(6,2,3);bar(pdfs(3,:));xlabel('Rectangle / pA');
subplot(6,2,4);bar(pdfs(4,:));xlabel('Rectangle / pU');
% for letter M:
subplot(6,2,5);bar(pdfs(5,:));xlabel('Square / pT');
subplot(6,2,6);bar(pdfs(6,:));xlabel('Square / pX');
% for letter U:
subplot(6,2,7);bar(pdfs(7,:));xlabel('Elipse / pA');
subplot(6,2,8);bar(pdfs(8,:));xlabel('Elipse / pH');
% for letter T:
subplot(6,2,9);bar(pdfs(9,:));xlabel('Cross / pM');
subplot(6,2,10);bar(pdfs(10,:));xlabel('Cross / pX');
% for letter X:
subplot(6,2,11);bar(pdfs(11,:));xlabel('Hexagon / pM');
subplot(6,2,12);bar(pdfs(12,:));xlabel('Hexagon / pT');
sgtitle("Incongr: Detailed - Predictions/Prob Distr on CE-data: ");
file_namee = "Evals/plots/" + str_date + "_incDETailed_psL_prD"+".png";
exportgraphics(f,file_namee);
clear figure;
